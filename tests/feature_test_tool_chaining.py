...
class TestToolChainingFeature(unittest.TestCase):
    ...
    def test_tool_chaining_subscriber_initialization_and_events(self):
        ...
        event = StreamEvent(type=StreamEventType.MCP_TOOL_CALL_DISPATCHED, data=event_data, provider=MagicMock())
    ...
    def test_tool_chaining_subscriber_handles_result_and_error(self):
        ...
        event = StreamEvent(type=StreamEventType.MCP_TOOL_CALL_RESULT, data={}, provider=MagicMock())
